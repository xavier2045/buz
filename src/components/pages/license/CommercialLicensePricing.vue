  ...
  <div class="commercial-license-pricing">
    ...
    <div class="license-section">
      ...
      <div class="pricing-grid">
        ...
        <div class="revenue-input-section" :class="{ 'disabled-section': true }">
...
const emit = defineEmits(['navigate-back', 'navigate-next', 'pricing-update']);

// 许可证价格和收入分成
const licensePrice = ref('');

// 验证价格和收入分成是否有效，只需验证价格是否填写
...
const goNext = () => {
  if (isPricingValid.value) {
    ...
    // 更新价格信息并导航到下一页
    emit('pricing-update', pricingData);
    emit('navigate-next');
  }
};
</script>
