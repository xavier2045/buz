<template>
  <div class="remix-permission-container">
...
const emit = defineEmits(['select-remix-permission', 'navigate-back']);
...
const goNext = () => {
  if (selectedOption.value) {
    emit('select-remix-permission', selectedOption.value);
  }
};
</script>

<style scoped>
.remix-permission-container {
  width: 100%;
  max-width: 800px;
