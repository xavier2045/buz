<template>
  <div class="blur-container">
    <!-- 添加独立的粒子背景组件，使用参数控制透明度 -->
    <ParticleBackground class="inner-background" :opacity="0.9" />
...
// 当前页面状态
const currentPage = ref('start'); // 'start', 'workType', 'license', 'assetDetails', 'creators', 'aiPermissionsSettings', 'reviewRegister'
