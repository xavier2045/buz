    ...
    <div class="agreement-content glow-effect">
      ...
      <div class="agreement-body no-padding custom-scrollbar">
        <div class="iframe-wrapper dark-scrollbar">
          <iframe src="/pdf/社区自律公约.pdf#zoom=page-fit&scrollbar=0&toolbar=0&navpanes=0&pagemode=none" width="100%" height="100%" frameborder="0" style="background-color: #111827;"></iframe>
