        ...
        <div v-if="activeTabIndex === 0" class="license-options">
          ...
          >
            ...
            <div class="license-footer">
              <div class="license-icons-simple">
...
.license-footer {
  ...
  min-height: 54px; /* 确保底部区域有足够的高度 */
}

.license-icons-simple {
  display: flex;
  align-items: center;
  gap: 16px; /* 给两个图标之间足够的间距 */
}
...
.icon {
  ...
  align-items: center;
  justify-content: center;
  opacity: 0.7; /* 稍微增加不透明度，使图标更明显 */
  font-size: 16px; /* 增加图标大小，使其更醒目 */
}
...
.license-icons-container {
  display: grid;
  grid-template-columns: repeat(4, 1fr); /* 使用网格布局代替弹性布局 */
  gap: 10px; /* 添加间隔，减小图标间距 */
  margin-top: auto;
  padding-top: 16px;
